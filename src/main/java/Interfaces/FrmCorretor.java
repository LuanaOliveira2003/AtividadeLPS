...
public class FrmCorretor extends javax.swing.JFrame {
    ...
    public FrmCorretor() throws ParseException, SQLException {
        this.funcEdit = null;
        lista = new ArrayList<>();
        initComponents();
        carregarTabela();
    ...
    public void objetosParaCampos(JTable tableCategories, int row) {
        ...
        this.row = row;
        edtId.setText(tblCorretor.getModel().getValueAt(row, 0).toString());
        edtNome.setText(tblCorretor.getModel().getValueAt(row, 1).toString());
        edtCpf.setText(tblCorretor.getModel().getValueAt(row, 2).toString());
        edtEndereco.setText(tblCorretor.getModel().getValueAt(row, 3).toString());
        edtIdade.setText(tblCorretor.getModel().getValueAt(row, 4).toString());
        edtSalario.setText(tblCorretor.getModel().getValueAt(row, 5).toString());
    }
    public void carregarTabela() throws SQLException{
        ...
        while (data.next()) {
            ...
            model.addRow(new Object[]{data.getString("id_corretor"), data.getString("nome"), data.getString("cpf"), data.getString("endereco"), data.getString("idade"), data.getString("salario")});
        }
      }
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Gerenciamento de Corretores");
        ...
        jScrollPane2.setViewportView(tblCorretor);
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
       int row = this.tblCorretor.getSelectedRow(); 
        if (row >= 0) {
            selectedId = 1;
            habilitarCampos(true);
            objetosParaCampos(this.tblCorretor, row);
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
       int row = tblCorretor.getSelectedRow();
        if (row >= 0) {
            try {
